...
package cn.baltics.springboot.starter.distributedid;

import cn.baltics.springboot.starter.distributedid.core.snowflake.Snowflake;
import cn.baltics.springboot.starter.distributedid.core.snowflake.SnowflakeIdInfo;
import cn.baltics.springboot.starter.distributedid.handler.IdGeneratorManager;

/**
 * SnowflakeIdUtil 分布式雪花 ID 生成器
 *
 * @author wbwyend
 * @date 2024/05/20
 */
