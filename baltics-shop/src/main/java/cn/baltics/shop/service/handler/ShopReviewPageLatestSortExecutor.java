...
@Component
@AllArgsConstructor
public class ShopReviewPageLatestSortExecutor implements AbstractStrategyExecutor<ShopReviewGetReqDTO, ShopReviewGetRespDTO> {
    private ShopReviewRepository shopReviewRepository;
    @Override
    public ShopReviewGetRespDTO executeResp(ShopReviewGetReqDTO requestParam) {
        return ShopReviewGetRespDTO.builder()
                .shopReviewList(shopReviewRepository.getLatestPage(requestParam.getShopId(),
    ...
    @Override
    public String mask() {
        return ShopReviewStrategyEnum.PAGE_LATEST.name();
    }
}
